...
'''
    ...
    <section class="dragon-detail-standalone-section" style="max-width: 900px; margin: 0.5rem auto; padding: 0 0.3rem;">
      <div style="margin-bottom: 0.8rem;">
        <a href="/" class="btn btn-secondary" style="text-decoration: none; display: inline-flex; align-items: center; gap: 8px; font-weight: 700; padding: 8px 14px; font-size: 0.9rem;">
